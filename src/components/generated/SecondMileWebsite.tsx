...
import { ArrowUpRight, CheckCircle2, XCircle, TrendingUp, ShieldCheck, Settings, Target, Zap, ChevronRight, PhoneCall, BarChart3, Menu, X, MapPin, Mail, Linkedin, Clock, Briefcase } from 'lucide-react';
...
const INDUSTRIES = [{
  name: 'HVAC',
  description: 'Optimizing dispatch and high-ticket service sales.'
}, {
  name: 'Plumbing',
  description: 'Dominating local search and emergency response conversions.'
}, {
  name: 'Electrical',
  description: 'Building systems for residential service and commercial bids.'
}, {
  name: 'Roofing',
  description: 'Scaling canvassing data into high-margin storm & retail jobs.'
}, {
  name: 'Med Spas',
  description: 'Fixing no-show rates and maximizing patient lifetime value.'
}, {
  name: 'Gyms',
  description: 'Automating lead nurture to turn day-passes into yearly contracts.'
}] as any[];
const SERVICES = [{
  id: 'audit',
...
const LogoLockup = () => <div className="flex items-center gap-3">
...
const Button = ({
  ...
  const baseStyles = "px-8 py-4 font-bold uppercase tracking-widest text-sm transition-all duration-300 inline-flex items-center gap-2";
  const variants: any = {
...
export const SecondMileWebsite = () => {
  ...
  // @return
  return <div className="min-h-screen bg-[#111418] text-[#F5F4F1] font-sans selection:bg-[#C65A1E] selection:text-white">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#111418]/95 backdrop-blur-md py-4 border-b border-white/5' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-10">
            {['Services', 'Industries', 'About', 'Audit'].map(item => <button key={item} onClick={() => setActiveTab(item.toLowerCase())} className={`text-xs uppercase tracking-widest font-semibold hover:text-[#C65A1E] transition-colors ${activeTab === item.toLowerCase() ? 'text-[#C65A1E]' : 'text-[#F5F4F1]'}`}>
                {item}
              </button>)}
        ...
        <AnimatePresence>
          ...
          height: 0
              ...
              <div className="flex flex-col p-6 gap-6">
                {['Services', 'Industries', 'About', 'Audit'].map(item => <button key={item} className="text-left text-xl font-bold uppercase tracking-wider" onClick={() => {
      ...
      <main className="pt-20">
        ...
        {activeTab === 'home' && <>
            <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
              ...
              duration: 0.8
                  ...
                  <div className="flex flex-col sm:flex-row gap-5">
                    ...
                    <Button variant="secondary" onClick={() => setActiveTab('services')}>See How It Works</Button>
                  </div>
                  
                  <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6" style={{
                translate: "0px -23px"
              }}>
                    {[{
                ...
                }].map((item, i) => <div key={i} className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#6B7280]">
                    ...
                    <div className="h-[300px] w-full">
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        color: '#F5F4F1'
                          ...
                          <Line type="monotone" dataKey="profit" stroke="#C65A1E" strokeWidth={4} dot={{
                        fill: '#C65A1E',
                        r: 4
                      }} activeDot={{
                        r: 8
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                  ...
                  <div className="space-y-6">
                    {["Missed calls that never get followed up", "Ads spending money but not converting", "Websites that look fine but don’t sell", "Pricing and processes bleeding margin", "No visibility into where profits are actually coming from"].map((item, i) => <motion.div whileHover={{
                  x: 10
                }} key={i} className="flex items-start gap-4 p-5 bg-white border border-black/5 shadow-sm">
                    ...
                    <div className="pt-6 border-t border-black/10 mt-10">
                      <p className="text-xl font-bold italic">
                        “We start where others don’t — inside your numbers, systems, and workflow.”
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
                  <div className="max-w-2xl">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black uppercase italic leading-[0.9]">We don’t guess. <br /> We audit <span className="text-[#C65A1E]">everything.</span></h2>
                  </div>
                  <Button variant="outline" onClick={() => setActiveTab('services')}>Full Service Breakdown</Button>
                </div>

                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1px bg-white/10 border border-white/10">
                  {SERVICES.map((service, i) => <div key={i} className="bg-[#111418] p-10 group hover:bg-[#1a1e23] transition-colors duration-500">
                      <div className="mb-8 text-[#C65A1E] group-hover:scale-110 transition-transform duration-500 origin-left">
                        {service.icon}
                      </div>
                      <h3 className="text-2xl font-black uppercase italic mb-6 leading-tight">{service.title}</h3>
                      <ul className="space-y-4">
                        {service.points.map((point, j) => <li key={j} className="flex items-center gap-3 text-sm text-[#6B7280] font-medium uppercase tracking-wider">
                  ...
                  <div className="bg-[#111418] p-10 flex flex-col justify-between group hover:bg-[#C65A1E] transition-all duration-500">
                    ...
                    <button className="flex items-center gap-2 font-black uppercase tracking-widest mt-12 group-hover:text-white" onClick={() => setActiveTab('audit')}>
            ...
            <section className="py-24 bg-[#1a1e23] border-y border-white/5">
              <div className="max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  desc: 'AI instantly scores and routes leads to the right team member'
                }, {
                  title: 'Automated Follow-Up',
                  desc: 'Never miss a callback with intelligent scheduling and reminders'
                }, {
                  title: 'Data Analysis at Scale',
                  desc: 'Surface insights from your CRM without manual spreadsheet work'
                }, {
                  title: 'Content & Ad Optimization',
                  desc: 'AI-driven testing to maximize ROI on every marketing dollar'
                }].map((item, i) => <div key={i} className="bg-[#111418] border border-white/5 p-6 hover:border-[#C65A1E]/30 transition-all group">
            ...
            <section className="py-32 bg-[#111418] border-t border-white/5 relative overflow-hidden">
              <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-24">
                  ...
                  <p className="text-[#6B7280] max-w-2xl mx-auto uppercase tracking-widest font-bold text-sm">Linear Growth via Systematic Optimization</p>
                </div>
                ...
                desc: 'We identify where money is leaking and where growth is capped.'
              }, {
                step: '02',
                title: 'Optimization & Cleanup',
                desc: 'We fix inefficiencies, tighten systems, and increase profit per lead.'
              }, {
                step: '03',
                title: 'Scale What Works',
                desc: 'Only after the foundation is fixed do we scale traffic and demand.'
              }].map((item, i) => <div key={i} className="bg-[#1a1e23] p-12 border border-white/5 relative group hover:border-[#C65A1E]/50 transition-all">
                      <span className="text-6xl font-black text-[#C65A1E]/10 absolute top-4 right-8 group-hover:text-[#C65A1E]/30 transition-colors">{item.step}</span>
              ...
              <div className="flex flex-col lg:flex-row min-h-[600px]">
                <div className="flex-1 bg-[#1a1e23] p-16 lg:p-24 flex flex-col justify-center">
                  ...
                  <div className="space-y-8">
                    {['Contractors doing $500k–$5M/year', 'Med spas with inconsistent bookings', 'Owners tired of guessing', 'Businesses ready to invest to grow'].map((item, i) => <div key={i} className="flex items-center gap-6">
                ...
                <div className="flex-1 bg-[#111418] p-16 lg:p-24 flex flex-col justify-center border-l border-white/5">
                  ...
                  <div className="space-y-8">
                    {['Cheap lead chasers', 'Businesses unwilling to change', 'Anyone looking for “just ads”', 'Short-term thinkers'].map((item, i) => <div key={i} className="flex items-center gap-6 opacity-60">
            ...
            <section className="py-32 bg-[#F5F4F1] text-[#111418]">
              <div className="max-w-7xl mx-auto px-6 text-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-left mb-20">
                  {["We look beyond marketing", "We understand service businesses", "We care about margins, not vanity metrics", "We act like operators, not vendors"].map((point, i) => <div key={i} className="p-8 border-l-4 border-[#C65A1E] bg-white shadow-lg">
            ...
            <section className="py-32 bg-[#111418] relative overflow-hidden text-center">
              ...
              <div className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <p className="text-2xl font-bold text-[#6B7280] uppercase mb-12 tracking-wider">
                  We’ll show you — for free.
                </p>
                <Button className="scale-125" onClick={() => setActiveTab('audit')}>Book My Free Audit</Button>
              </div>
            </section>
          </>}

        {/* SERVICES PAGE CONTENT */}
        {activeTab === 'services' && <section className="py-24 max-w-7xl mx-auto px-6">
            <h1 className="text-6xl font-black uppercase italic mb-16 border-b border-white/10 pb-8">Our Services</h1>
            <div className="space-y-32">
              {SERVICES.map((service, i) => <div key={i} className="grid lg:grid-cols-2 gap-20 items-center">
                  <div className={i % 2 !== 0 ? 'lg:order-2' : ''}>
                    ...
                    <p className="text-xl text-[#6B7280] mb-8 italic">
                      High-impact optimization focused on bottom-line profitability and operational freedom.
                    </p>
                    <ul className="space-y-4">
                      {service.points.map((p, idx) => <li key={idx} className="flex items-center gap-4 text-lg font-bold uppercase tracking-tight">
        ...
        {activeTab === 'industries' && <section className="py-24 max-w-7xl mx-auto px-6">
            <h1 className="text-6xl font-black uppercase italic mb-16 border-b border-white/10 pb-8">Industries We Serve</h1>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {INDUSTRIES.map((ind, i) => <div key={i} className="bg-[#1a1e23] p-12 border border-white/5 hover:border-[#C65A1E]/50 transition-all group">
                  ...
                  <Button variant="outline" className="w-full justify-center">View Strategy</Button>
                </div>)}
            </div>
          </section>}

        {/* ABOUT PAGE CONTENT */}
        {activeTab === 'about' && <section className="py-24 max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-20">
              <div>
                ...
                <p className="text-xl text-[#6B7280] mb-8 leading-relaxed">
                  Second Mile Growth Co. was founded on a simple principle: doing the bare minimum isn't enough to build a category-leading business. 
                  We dive deep into the numbers where most agencies are afraid to look.
                </p>
                <div className="grid grid-cols-2 gap-8 mt-16">
                  {['Discipline', 'Clarity', 'Accountability', 'Performance'].map((val, i) => <div key={i}>
        ...
        {activeTab === 'audit' && <section className="py-24 max-w-4xl mx-auto px-6">
...
<p className="text-center text-[#6B7280] text-[10px] font-bold uppercase tracking-widest">
  Only 2 Audit Slots Left This Month
          ...
          <div className="grid lg:grid-cols-4 gap-16 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 font-bold uppercase text-xs tracking-[0.2em]">
                {['Services', 'Industries', 'About', 'Audit'].map(item => <li key={item} className="cursor-pointer hover:text-[#C65A1E] transition-colors" onClick={() => {
                setActiveTab(item.toLowerCase());
                scrollToTop();
              }}>
                    {item}
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full p-4 bg-[#111418]/90 backdrop-blur-md border-t border-white/10 z-50">
        <Button className="w-full justify-center py-4" onClick={() => setActiveTab('audit')}>Book Free Audit</Button>
      </div>
    </div>;
};
